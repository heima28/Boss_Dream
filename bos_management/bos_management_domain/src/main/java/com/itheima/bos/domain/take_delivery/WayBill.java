...
public class WayBill {
    ...
    private String recMobile;//10 收件人电话
    ...
    private String goodsType;//15 托寄物类型：文件、衣服 、食品、电子商品
    ...
    private String arriveCity; //20 到达地
    ...
    private String wayBillType; //25  运单类型（类型包括：正常单据、异单、调单）
    /*
